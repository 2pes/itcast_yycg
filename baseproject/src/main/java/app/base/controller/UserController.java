...
import app.base.pojo.vo.PageQuery;
import app.base.pojo.vo.SysuserCustom;
import app.base.pojo.vo.SysuserQueryVo;
import app.base.process.result.DataGridResultInfo;
import app.base.process.result.ResultInfo;
import app.base.process.result.SubmitResultInfo;
...
public class UserController {
	...
	public DataGridResultInfo queryuser_result(
			...
			@RequestParam(required = false, defaultValue = "10") int rows//每页显示个数
			)throws Exception{
